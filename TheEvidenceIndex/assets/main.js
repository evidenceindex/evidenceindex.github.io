...
(function() {
					...
					'dandermain': {
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Dandermain',
										'page_location': '/#dandermain',
									});
								},
								function() { 
	...
	// Initialize "On Visible" animations.
		...
		onvisible.add('#text31', { style: 'fade-down', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container23', { style: 'fade-in', speed: 500, intensity: 2, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text33', { style: 'fade-down', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		...
		onvisible.add('#text39', { style: 'fade-down', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container25', { style: 'fade-in', speed: 500, intensity: 2, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text43', { style: 'fade-down', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container24', { style: 'fade-in', speed: 500, intensity: 2, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text44', { style: 'fade-down', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#buttons07', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		...
		onvisible.add('#text36', { style: 'fade-down', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
